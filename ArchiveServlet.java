...
public class ArchiveServlet extends HttpServlet{
	...
	//private static String cacheDirPath = "/usr/local/apache-tomcat-8.0.23/webapps/ROOT/WEB-INF/classes/cached-archives/";
	...
	*/
	...
	public static void main(String[] args) throws IOException {
		...
		Map<String, Map<String, String>> map = gson.fromJson(new FileReader(cacheDirPath + fileName), stringStringMap);
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String functionName = request.getParameter("functioname");
		...
		response.getWriter().println(map.get(objectName).get(functionName));
	}
}
